...
const VERSION='v0.9.166-rules-core',MAX_HP=40,HAND_SIZE=5,MAX_MOM=99,DEFAULT_MATCH_TURN_LIMIT=50,MIN_MATCH_TURN_LIMIT=20,MAX_MATCH_TURN_LIMIT=150,MATCH_TURN_LIMIT_STEP=10,STORE='wa-mobile-v0943',BACKUP_STORE='wa-mobile-backup-v0953';
...
const STARTER_UNLOCK_IDS=new Set(["2ndRopeLegDropEX2", "AbdominalStretch", "AchillesHeel2EV095", "AdvantageTechnicalV095", "AggressiveStrength", "Agility2E", "AgilityEX1", "AgilityEX2", "AheadOfTheGameV095", "AlwaysThinking2EV095", "AlwaysThinkingV095", "AngleSlam2E", "AnkleKeyLock", "ArmDragTakedown", "ArmStretch", "Armbar", "ArmbarEX3", "ArmbarTakedown", "AsaiMoonsault2E", "AtomicDrop", "BackBodyDrop", "BackBodyDropOverTheRopes", "BackElbow", "BackHeelTrip", "BackHeelTripEX3", "BackSuplex", "BackflipSplash", "BaseballSlideEX2", "BearHug", "BellyToBellySuplex2E", "BellyToBellyToRingside", "BigAndNasty2EV095", "BigBackBodyDrop", "BigandNastyEX1V095", "BodySlam", "BoringV095", "BounceOffTheRopes2EV095", "BounceOffTheRopesV095", "Break2EV095", "BreakEX2V095", "BubbaBomb", "BubbaRayV095", "BuildingMomentumV095", "Bulldog", "Bulldog2E", "ButtShot", "CamelClutchEX2", "CaptureSuplex", "CatchHimStunnedV095", "ChairShotEX2", "Chop", "Clip2E", "ClipEX2", "ClotheslineFromHell", "ClotheslineInTheCorner", "ClotheslineOverTheRopes", "ClotheslineOverTheRopesEX2", "Compactor", "CompactorEX2", "CornerBarage", "CornerBarrage2E", "CowBellShot", "DDT", "DDT2E", "DDTEX1", "DVonEX2V095", "DVonV095", "DeathblowLE", "Disadvantage2EV095", "DistractTheReferee", "DistractTheReferee2EV095", "DoubleBackBreaker", "DoubleLegTakedown2E", "DoublePowerbomb", "DoubleUnderhookSuplex", "DoubleUnderhookSuplex2E", "DragonSleeper2E", "DragonSuplex", "DropKickOverTheRopes", "DropKickToTheFloor2E", "DropKickToTheKnee", "DudleyDog", "EarClap", "Elbow", "ElbowToBackOfTheHead2E", "Enzugiri", "EuropeanUppercut", "EuropeanUppercutEX3", "EverythingHurtsV095", "EyeOfTheHurricane", "EyeOfTheHurricaneLE", "EyeRake2E", "F5", "Facebuster", "Facebuster2E", "FallawaySlam", "FigureFour2E", "FiremansCarry", "FishermansSuplex", "FiveStarFrogSplash", "FiveStarFrogSplashEX2", "FloatoverDDT", "FlyingWheelKick", "ForearmSmash", "ForearmSmash2E", "FrogSplash2E", "FrogSplashEX1", "FrontHeelTrip", "FujiwaraArmbar", "FullNelsonSlam", "GermanSuplex", "GetAShoulderUpV095", "GoingUpTopV095", "GoldenGlobes", "GreatImpact", "GuitarShot", "GutBuster", "GutWrenchSuplex", "GutWrenchSuplex2E", "Hammerlock", "HardcoreEX3V095", "Headlock", "HelloV095", "HesCallingForIt", "HeyRefThatWasThreeV095", "HighCrossBodyEX3", "HighKnee2E", "HighSpotV095", "HipToss", "HookTheLeg2EV095", "HookTheLegEX2V095", "HookTheLegV095", "IGotYourBack2EV095", "InsideCradle", "InsideC
ace2E", "Original_CrossArmBreaker2E", "Original_CurtainCall", "Original_DiveToTheFloor", "Original_Dodge", "Original_Dodge2E", "Original_DoubleLegTakedownEX2", "Original_DropKick", "Original_DropKick2E", "Original_Duck2E", "Original_Edgecution2E", "Original_Edgeomatic2E", "Original_Elbow2E", "Original_ElbowDropEX3", "Original_ElbowToTheBackOfTheHead", "Original_ElbowToTheBackOfTheHeadEX2", "Original_EnzugiriEX2", "Original_FiremansCarryEX2", "Original_FistDrop", "Original_FistDrop2E", "Original_FlatOfTheFoot", "Original_FlatOfTheFoot2E", "Original_FlatOfTheFootEX2", "Original_FlippingFaceSlam", "Original_FloatoverDDT2E", "Original_FlyingArmbarTakedown", "Original_GermanSuplex2E", "Original_Hammerlock2E", "Original_HighCrossBody", "Original_HipTossEX2", "Original_HogansBigBoot2E", "Original_HogansBigBoot2ELE", "Original_HogansLegDrop2E", "Original_HogansLegDrop2ELE", "Original_InsideCradle2E", "Original_JawbreakerEX2", "Original_KneeLift2E", "Original_KneeLiftEX3", "Original_LegDrop", "Original_LegDrop2E", "Original_LegSweep", "Original_LowBlowChairShot", "Original_LowBlowUppercut2E", "Original_MafiaKick", "Original_MafiaKick2E", "Original_Moonsault", "Original_Moonsault2E", "Original_Neckbreaker2E", "Original_NoHandsPlancha", "Original_OlympicSlam", "Original_Pedigree", "Original_Pedigree2E", "Original_PokeInTheEye", "Original_PowerBomb", "Original_PowerBomb2E", "Original_PowerSlam2E", "Original_PowerfulClothesline", "Original_PumpHandleSlamEX2", "Original_Punch2E", "Original_RegalStretch", "Original_ReverseDDT2E", "Original_RicFlairsFigureFour", "Original_RicFlairsFigureFourLE", "Original_SamoanDrop2E", "Original_SamoanDropEX2", "Original_Shove", "Original_Shove2E", "Original_SideKick", "Original_SidewalkSlamEX2", "Original_SnapMare2E", "Original_SnapSuplex2E", "Original_SplashEX2", "Original_Splash_Core", "Original_SpringboardDropKick", "Original_StandingSwitch", "Original_StandingSwitch2E", "Original_StephanieMcMahonHelmsley_Core", "Original_StratusfactionLE", "Original_StratusphereLE", "Original_SuperplexEX3", "Original_Tazzmission", "Original_TheBigBootEX2", "Original_TheRocksDDT2E", "Original_TrishsChop", "Original_TrishsRoundhouseKickLE", "Original_UpAndOver", "Original_UpAndOver2E", "Original_UseTheRopesForLeverage", "Original_VerticalSuplex2E", "Original_special1", "Overcast", "OvercastLE", "Piledriver", "PlanchaEX2", "PowerBombEX2", "PowerBombFromTheLadder", "PowerSlam", "PressSlam", "PressSlamEX2", "PumpHandle", "PumpHandleSlam", "Punch", "PunchesInTheCorner", "RazorsEdge", "ReverseChinlock", "ReverseDDT", "RicFlairsChopLE", "RikishiDriver", "RollingGermanSuplex2E", "RoundKick", "RoundKick2E", "RoundKickEX2", "RunningClotheslineEX2", "RunningElbow", "RunningNeckbreaker", "RussianLegSweep", "RussianLegSweep2E", "RussianLegSweepEX1", "SamoanDrop", "SavageElbow", "SentonSplash2E", "SentonSplashEX1", "ShiningWizardKick", "ShortArmClothesline", "ShoulderBlock", "ShoulderBlockEX3", "ShoulderToMidsection", "SidewalkSlam", "Slap", "Slap2E", "Sleeper2E", "SnakeEyes", "SnakeEyes2E", "SnapMare", "SnapSuplex", "SoloConchairto", "Spear", "SpineBuster", "SpineKick", "SpinningHeelKick2E", "SpinningHeelKickCore", "SpinningHeelKickEX1", "SpinningPowerbomb", "SpinningPowerslam", "StraightJacketTakedown", "StraightRightHand", "StraightShooter", "Stratusfaction", "Strength2E", "StrengthEX1", "StrengthEX2", "StrengthTourn", "Strike2E", "StrikeEX1", "StrikeEX2", "StrikeTourn", "StrongClothesline", "SunsetFlip", "SuperMomentumLE", "Superkick", "SuplexOntoTheRopes", "SuplexToTheFloor", "Surfboard", "SwantonBomb", "SwantonBombEX2", "SweetChinMusic", "Taunt", "Taunt2E", "Technical2E", "TechnicalEX1", "TechnicalEX2", "TechnicalTourn", "TheBigElbowEX2", "TheFinalCut2E", "TheFinalCutEX1", "TheGuillotine", "TheLastRide2E", "TheLastRideEX1", "ThePeoplesElbow", "ThePeoplesElbow2E", "ThePeoplesElbow2ELE", "ThrowOffTheStage", "ThrowOverTheRopes2E", "ThrustKick", "ThrustKick2E", "ThrustUppercut", "TombstonePiledriver2E", "TopRopeClothesline2E", "TornadoDDT", "TreeOfWoe2E", "TurnbuckleSmash", "TwistOfFate", "Unprettier", "VerticalSuplex", "WallsOfJericho", "WallsOfJericho2E", "Wazzzzzaaaappp", "WillToWin", "WraparoundNeckbreaker", "XFactor", "original-duck", "original-headlock2e"]);
...
function runOriginalCardEvent(event,k,c,extraEnv={}){
  ...
  engine.WAMessage=text=>{addLog(`${c.name}: ${String(text??'')}`);return text};
...
function showCards(activeSet='CORE',mode='all'){ensureRewardProfile();const selected=BOOSTER_CONFIG.sets[activeSet]?activeSet:'CORE',s=setCompletionStats(selected);let list=[...s.list];if(mode==='missing')list=list.filter(c=>ownedCount(c)<cardCopyCap(c));if(mode==='owned')list=list.filter(c=>ownedCount(c)>0);list.sort((a,b)=>ownedCount(b)-ownedCount(a)||String(a.name).localeCompare(String(b.name)));app.innerHTML=`<section class="screen"><div class="topbar"><button class="secondary compact" onclick="home()">Back</button><b>CARD COLLECTION</b><span>${s.ownedUnique}/${s.list.length}</span></div><div class="setTabs">${Object.entries(BOOSTER_CONFIG.sets).map(([k,v])=>`<button class="secondary compact ${k===selected?'active':''}" onclick="showCards('${k}','${mode}')">${esc(v.name)}</button>`).join('')}</div><div class="collectionSetHero">${BOOSTER_CONFIG.sets[selected].packImage?`<img src="${BOOSTER_CONFIG.sets[selected].packImage}" alt="">`:''}<div><h2>${esc(BOOSTER_CONFIG.sets[selected].name)}</h2><p>${s.completed}/${s.list.length} cards complete</p><p>${s.ownedCopies}/${s.totalCopies} copies owned</p></div></div><div class="filterbar"><button class="secondary compact" onclick="showCards('${selected}','all')">All</button><button class="secondary compact" onclick="showCards('${selected}','owned')">Owned</button><button class="secondary compact" onclick="showCards('${selected}','missing')">Missing / incomplete</button></div><div class="library originalCardLibrary">${list.map(c=>staticOriginalCardHtml(c,`×${ownedCount(c)}/${cardCopyCap(c)}`,`<div class="originalCardNote">${ownedCount(c)>=cardCopyCap(c)?'Complete':ownedCount(c)?`Need ${cardCopyCap(c)-ownedCount(c)} more`:'Not owned'}</div>`)).join('')||'<p class="instruction">No cards in this view.</p>'}</div></section>`}
